...
class SyncConfigureForm extends FormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    // Hide this field, removing causes an error.
    $form['import_tarball'] = [
      '#type' => 'file',
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    // Set hardcoded path to config file.
    $form_state->setValue('import_tarball', $_SERVER['DOCUMENT_ROOT'] . base_path() . 'profiles/config_installer/config.tar.gz');
    $has_upload = TRUE;
