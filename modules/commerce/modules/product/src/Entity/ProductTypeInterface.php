...
interface ProductTypeInterface extends ConfigEntityInterface, EntityDescriptionInterface {
  ...
  /**
   * Checks if the product type supports injected variation fields.
   *
   * @return bool
   *   Whether to inject variation fields.
   */
  public function hasInjectedVariationFields();

  /**
   * Sets the product type's injected variation fields status.
   *
   * @param bool $inject
   ...
   * @return $this
   */
  public function setInjectedVariationFields($inject = TRUE);
